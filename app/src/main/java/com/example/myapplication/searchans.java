...
public class searchans extends AppCompatActivity {

    private RecyclerView recyclerView;
    private CustomAdapter adapter;
    private List<SearchPatientInfo> dataList;
    private List<SearchPatientInfo> filteredList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_searchans);
        ...
        fetchfromPHP("");
        SearchView searchView = findViewById(R.id.searchans1);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                dataList.add(new SearchPatientInfo(id, name));
                            }
    ...
    private void filter(String text) {
        ...
        if (text.isEmpty()) {
            ...
            for (SearchPatientInfo item : dataList) {
    ...
    class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.ViewHolder> {
        ...
        public CustomAdapter(List<SearchPatientInfo> dataList) {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            SearchPatientInfo patient = dataList.get(position);
...
class SearchPatientInfo {
    private String id;
    private String name;

    public SearchPatientInfo(String id, String name) {
        this.id = id;
        this.name = name;
    }
