...
public class q10 extends AppCompatActivity {
            ...
            public void onClick(View v) {
                if (trueRadioButton.isChecked() || falseRadioButton.isChecked()) {
                    ...
                    if (selectedRadioButtonId == -1) {
                        ...
                        Toast.makeText(q10.this, "Please select an option", Toast.LENGTH_SHORT).show();
                        return;
                    }

                    RadioButton selectedRadioButton = findViewById(selectedRadioButtonId);
                    String q10Value = (selectedRadioButton.getId() == R.id.tr) ? "Yes" : "No";

                    // Intent to move to the next activity
                    int updatedTotalMark = totalMark + previousTotalMark;
                    Intent intent = new Intent(q10.this, resultsq.class); // Replace ResultActivity with your actual result activity
                    ...
                    sendDataToServer(patientId, q10Value);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(q10.this, "Data sent to the database", Toast.LENGTH_SHORT).show();
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        // Handle errors
                        Toast.makeText(q10.this, "Error sending data to the database", Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
    ...
    private void sendDataToServer(final String patientId, final String q10Value) {
