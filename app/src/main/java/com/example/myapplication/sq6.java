...
public class sq6 extends AppCompatActivity {
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedRadioButtonId == -1) {
                    Toast.makeText(sq6.this, "Please select an option", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Intent intent = new Intent(sq6.this, sq7.class);
    ...
    private void sendDataToServer(String patientId, String q6Value) {
        String url = "http://10.0.2.2/Php/updatescreening.php";
        Log.d(TAG, "Value of q4: " + q6Value);
