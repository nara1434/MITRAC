...
public class q6 extends AppCompatActivity {
            ...
            public void onClick(View v) {
                if (trueRadioButton.isChecked() || falseRadioButton.isChecked()) {
                    ...
                    if (selectedRadioButtonId == -1) {
                        ...
                        Toast.makeText(q6.this, "Please select an option", Toast.LENGTH_SHORT).show();
                        return;
                    }

                    RadioButton selectedRadioButton = findViewById(selectedRadioButtonId);
                    String q6Value = (selectedRadioButton.getId() == R.id.tr) ? "Yes" : "No";

                    // Intent to move to the next activity
                    int updatedTotalMark = totalMark + previousTotalMark;
                    Intent intent = new Intent(q6.this, q7.class); // Replace NextActivity with your actual next activity
                    ...
                    sendDataToServer(patientId, q6Value);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(q6.this, "Data sent to the database", Toast.LENGTH_SHORT).show();
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        // Handle errors
                        Toast.makeText(q6.this, "Error sending data to the database", Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
    ...
    private void sendDataToServer(final String patientId, final String q6Value) {
